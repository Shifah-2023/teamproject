...
if (isset($_GET['id'])) {
    $obj->ID = $_GET['id'];
    $result = $obj->deleteProjectType();
    if ($result == PROJECTTYPE_DELETED) {
        $msg['error'] = false;
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-12">
                                <div class="card">
                                    ...
                                    <h4 style="text-align: center;">ALL PROJECT TYPES</h4>
                                    <?php
                                    $obj = new Operations();
                                    $result = $obj->getAllProjectTypes();
                                    ?>
                                    <div class="card-body">
                                            ...
                                            ?>
                                                <table class="table table-striped table-md">
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td><?= $res['sn'] ?></td>
                                                            <td><?= $res['project_types'] ?></td>
                                                            <td><?= $res['groups'] ?></td>
                                                            <td><?= $res['individual'] ?></td>
                                                            <td>
                                                                <a href="editprojectypes.php?id=<?= $res['ID'] ?>"><button class="btn btn-success">Edit</button></a>
                                                                <a href="viewprojectypes.php?id=<?= $res['ID'] ?>
                                                    ...
                                                    ?>
                                                        ...
                                                        ?><center><?php
                                                                    echo 'NO ADDED PROJECTS.<a href="createprojectype.php"><button class="btn btn-primary">CLICK HERE TO  CREATE.</button></a>'; ?></center> <?php
                                                                                                                                                                                                        }
                                                                                                                                                                                                            ?>
