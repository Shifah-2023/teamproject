            ...
            <div class="row">
              <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                  ...
                  <h4 style="text-align: center;">VIEW CREATED TESTS</h4>
                  <?php
                  $obj = new Operations();
                  $result = $obj->retrieveAllTests();
                  ?>
                  <div class="card-body">
                        ...
                        <table class="table table-striped table-md">
                          ...
                          foreach ($result as $res) {
                            ...
                            <tr>
                              ...
                              <td>
                                <a href="edittest.php?id=<?= $res['ID'] ?>"><button class="btn btn-success">Edit</button></a>
                                <a href="viewtests.php?id=<?= $res['ID'] ?>
                          ...
                          ?>
                                  ...
                                  ?><center><?php
                                            echo 'NO TEST CREATED<a href="createtest.php"><button class="btn btn-primary">CLICK HERE TO CREATE</button></a>';
                                            ?></center> <?php
                                                      } ?>
                    </div>
                  </div>
