            ...
            <div class="row">
              <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                  ...
                  <h4 style="text-align: center;">All Project Marks</h4>
                  <?php
                  $obj = new Operations();
                  $result = $obj->getAllProjectMarks();
                  ?>
                  <div class="card-body">
                        ...
                        <table class="table table-striped table-md">
                          ...
                          foreach ($result as $res) {
                            ...
                            <tr>
                              ...
                              <td><?= $res[''] ?></td>
                              <td>
                                <a href="editprojmarks.php?id=<?= $res['ID'] ?>"><button class="btn btn-success">Edit</button></a>
                                <a href="viewprojectmarks.php?id=<?= $res['ID'] ?>
                          ...
                          ?>
                                  ...
                                  ?><center><?php
                                            echo 'NO PROJECT MARKS.<a href="createproj_marks.php"><button class="btn btn-primary">CLICK HERE TO CREATE</button></a>';  ?></center> <?php
                                                                                                                                                                                    } ?>
                    </div>
                  </div>
                </div>
