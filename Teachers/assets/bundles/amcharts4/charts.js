          ...
          return (
            ...
            (t.prototype.triggerMoveReal = function (e) {
              ;(this.point.x == e.x && this.point.y == e.y) ||
                ...
                this.visible &&
                  (this.getPositions(), this.dispatch('cursorpositionchanged')))
            }),
        ...
        W = (function (e) {
          ...
          return (
            ...
            Object.defineProperty(t.prototype, 'selection', {
              ...
              set: function (e) {
                ;(this._selection = e),
                  e && ((e.element = this.paper.add('path')), (e.parent = this))
              },
              enumerable: !0,
              configurable: !0,
            }),
          ...
          return (
            ...
            (t.prototype.handleWheel = function (e) {
              var t = this.plotContainer,
                i = F.documentPointToSvg(e.point, this.phpContainer),
        ...
        We = (function (e) {
          ...
          return (
            ...
            (t.prototype.validate = function () {
              ...
              s = g.getCommonRectangle([s, { x: 0, y: 0, width: 0, height: 0 }])
            ...
            (t.prototype.validateDataElementReal = function (e) {
              ...
              if (this.xAxis instanceof b && this.yAxis instanceof b) {
                ...
                if (((r = 0), (o = 1), !f.isNaN(p)))
                  (r += k = g.round(((o - r) * (1 - p / 100)) / 2, 5)), (o -= k)
                if (
                ...
                var k
                if (!f.isNaN(y))
                  (r += k = g.round(((o - r) * (1 - y / 100)) / 2, 5)), (o -= k)
                if (
                  ((a = this.yAxis.getY(e, d, r)),
                  (n = this.yAxis.getY(e, u, o)),
                  f.isNaN(y))
              ...
              get: function () {
                return (
                  this._dropFromOpenState ||
                    (this._dropFromOpenState = this.states.create(
                      'dropFromOpenState',
                    )),
                  this._dropFromOpenState
                )
              ...
              get: function () {
                return (
                  this._riseFromOpenState ||
                    (this._riseFromOpenState = this.states.create(
                      'riseFromOpenState',
                    )),
                  this._riseFromOpenState
                )
