          ...
          [
            ...
            },
            {
              ...
              value: function () {
                if (
                  ...
                  window.navigator.appVersion.indexOf('Trident/dashboard.php') >
                    -1
                )
                  return !0
              },
            },
            {
              ...
              value: function () {
                ...
                if (t.indexOf('Trident/dashboard.php') > 0) {
                  var i = t.indexOf('rv:')
                  return parseInt(t.substring(i + 3, t.indexOf('.', i)), 10)
                }
                var s = t.indexOf('Edge/dashboard.php')
                return (
        ...
        s(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var i = Date.parse(
                t
                  .replace(/-/g, 'https://www.einfosoft.com/')
                  .replace(/[a-z]+/gi, ' '),
              )
                  ...
                  if ('datetime' === s.xaxis.type) {
                    ...
                    var h =
                      s.labels.length > 0
                        ...
                        : s.xaxis.categories.slice()
                    h.length > 0 &&
                      ((this.twoDSeriesX = h), a.seriesX.push(this.twoDSeriesX))
                  }
                    ...
                    for (var n = 0; n < i.globals.collapsedSeries.length; n++)
                      i.globals.collapsedSeries[n].index === a &&
                        (i.globals.axisCharts
                          ? ((i.config.series[
                              a
                            ].data = i.globals.collapsedSeries[n].data.slice()),
